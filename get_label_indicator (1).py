...
if __name__ == '__main__':
    df = pd.read_csv("/data/market_maker/origin_data/S10_data_20240107.csv",index_col = 0)
    ...
    # 打印新的DataFrame
    df_result.to_csv("/data/market_maker/label_data/label_indicator_data_20240107.csv")